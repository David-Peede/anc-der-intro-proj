...
# Define file paths.
vcf_path = './tgp_altai_merged_filtered_biallelic_chr{0}.vcf.gz'.format(str(sys.argv[1]))
zarr_path = './zarr_arrays/tgp_altai_merged_filtered_biallelic_chr{0}.zarr'.format(str(sys.argv[1]))
