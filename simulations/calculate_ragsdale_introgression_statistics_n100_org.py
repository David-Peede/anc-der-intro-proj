...
simulated_genotype_matrix = np.loadtxt(
    './non_iua_models/ragsdale_2019/n_100/org/geno_mats/rep_id_{0}_geno_mat.csv.gz'.format(rep_id),
    dtype=int, delimiter=',',
)
...
results_prefix = './non_iua_models/ragsdale_2019/n_100/org/obs_vals/rep_id_{0}_'.format(rep_id)
