...
simulated_genotype_matrix = np.loadtxt(
    './sim_outputs/ooa_arc_intro/geno_mats/rep_id_{0}_geno_mat.csv.gz'.format(rep_id),
    dtype=int, delimiter=',',
)
simulated_variable_positions = np.loadtxt(
    './sim_outputs/ooa_arc_intro/var_pos/rep_id_{0}_var_pos.csv.gz'.format(rep_id),
    delimiter=',',
)
...
results_prefix = './sim_outputs/ooa_arc_intro/bootstraps/rep_id_{0}_'.format(rep_id)
