...
simulated_genotype_matrix = np.loadtxt(
    './non_iua_models/ragsdale_2019/{0}/geno_mats/rep_id_{1}_geno_mat.csv.gz'.format(f, rep_id),
    dtype=int, delimiter=',',
)
simulated_variable_positions = np.loadtxt(
    './non_iua_models/ragsdale_2019/{0}/var_pos/rep_id_{1}_var_pos.csv.gz'.format(f, rep_id),
    delimiter=',',
)
...
results_prefix = './non_iua_models/ragsdale_2019/{0}/bootstraps/rep_id_{1}_'.format(f, rep_id)
