...
class Bootstrap:
    ...
    simulated_genotype_matrix = np.loadtxt(
        './non_iua_models/ragsdale_2019/n_100/org/geno_mats/rep_id_{0}_geno_mat.csv.gz'.format(int(sys.argv[1])),
        dtype=int, delimiter=',',
    )
    simulated_variable_positions = np.loadtxt(
        './non_iua_models/ragsdale_2019/n_100/org/var_pos/rep_id_{0}_var_pos.csv.gz'.format(int(sys.argv[1])),
        delimiter=',',
    )
...
results_prefix = './non_iua_models/ragsdale_2019/n_100/org/bootstraps/rep_id_{0}_'.format(int(sys.argv[1]))
